========================================================================
       DEVELOPER STUDIO ADD-IN : UpdateVersion
========================================================================


The Add-in Wizard has created this UpdateVersion DLL for you.  This DLL not only
...
make up your UpdateVersion DLL.


UpdateVersion.h
	This is the main header file for the DLL.  It declares the
	CUpdateVersionApp class.

UpdateVersion.cpp
	This is the main DLL source file.  It contains the class CUpdateVersionApp.
...
Commands.cpp, Commands.h
    ...
    a sample command (UpdateVersionCommand) which displays a message
...
StdAfx.h, StdAfx.cpp
    ...
    named UpdateVersion.pch and a precompiled types file named StdAfx.obj.
