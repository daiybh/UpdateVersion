// UpdateVersion.cpp : Defines the initialization routines for the DLL.
//
...
// Overrides
	...
	//{{AFX_VIRTUAL(CUpdateVersionApp)
	public:
	virtual BOOL InitInstance();
	virtual int ExitInstance();
	//}}AFX_VIRTUAL

	//{{AFX_MSG(CUpdateVersionApp)
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CUpdateVersionApp object

CUpdateVersionApp theApp;

/////////////////////////////////////////////////////////////////////////////
// CUpdateVersionApp construction
...
/////////////////////////////////////////////////////////////////////////////
// CUpdateVersionApp initialization
...
int CUpdateVersionApp::ExitInstance()
{
	_Module.Term();
...
STDAPI DllRegisterServer(void)
{
	...
	if (lRes == ERROR_SUCCESS)
	{
		...
		if (lRes == ERROR_SUCCESS)
		{
			...
			strDescription.LoadString(IDS_UPDATEVERSION_DESCRIPTION);
