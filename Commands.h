...
#if !defined(AFX_COMMANDS_H__42F35090_9F14_4AFA_85BE_3E64BF5A9A13__INCLUDED_)
#define AFX_COMMANDS_H__42F35090_9F14_4AFA_85BE_3E64BF5A9A13__INCLUDED_

#include "UpdateVersionTypes.h"
#include "OptionDlg.h"
#include "BackupFile.h"
#include "ZipProj.h"

class CCommands : 
	public CComDualImpl<ICommands, &IID_ICommands, &LIBID_UpdateVersion>, 
...
protected:
	...
	class XApplicationEvents : public XEventHandler<IApplicationEvents, 
		&IID_IApplicationEvents, &LIBID_UpdateVersion, 
	...
	public:
		...
		void GetFileData( IN CString strProjectName, OUT CString &outData );
		UINT GetWorkSvnVersion(IN CString strCurrentPath, BOOL bRootPath = FALSE); // TRUE is rootpath, FALSE is current path;		
		CString GetRegexpData( IN CString Data, IN LPCTSTR lpRegexp, IN DWORD dwRegexpType, LPCTSTR sNamedGroup = NULL);
		CString ReplaceRegexpData( IN CString Data, IN LPCTSTR lpRegexp, IN DWORD dwRegexpType, IN LPCTSTR lpRegexpReplace );
		void SetFileData( IN CString strFileName, IN CString Data );
		void UpdataVersionInfo( UINT uVerArr[], CONFIG config, UINT uSvnVersion = 0);
		static VOID WINAPI ManualCallBackProc( PMANUALCALLBACK lpManuallCallBack );
		DWORD ReleaseResourceToFile( LPCSTR lpFileName, INT iResID, LPCSTR lpType );
	};
	...
	class XDebuggerEvents : public XEventHandler<IDebuggerEvents, 
		&IID_IDebuggerEvents, &LIBID_UpdateVersion, 
...
public:
// ICommands methods
	STDMETHOD(UpdateVersionCommand)(THIS);
	STDMETHOD(ZipFolderCommand)(THIS);
};
...
#endif // !defined(AFX_COMMANDS_H__42F35090_9F14_4AFA_85BE_3E64BF5A9A13__INCLUDED)
